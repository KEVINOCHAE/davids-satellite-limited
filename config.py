...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = SQLALCHEMY_DATABASE_URI = os.getenv('DATABASE_URL') #'postgresql://postgres:fZBdgziLbMVLyOkyWrKleHxkxiFeroIf@monorail.proxy.rlwy.net:58355/railway'
