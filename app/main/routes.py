...
services_data = {
    ...
    'general_merchandise_supplies_services': {
        ...
        'more_info': (
            'We supply IT Security hardware such as Hikvision and Dahua CCTV Cameras and Accessories, Access Control devices and Accessories. We also sell Tv Aerials and Satellite hardwares,Dashcams, Networking devices such as Routers, Gateways, ethernet cables and more. '
